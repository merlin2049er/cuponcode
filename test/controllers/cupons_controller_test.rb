...
class CuponsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cupon" do
    assert_difference('Cupon.count') do
      post cupons_url, params: { cupon: { code: @cupon.code, comment: @cupon.comment, end: @cupon.end, start: @cupon.start, valid: @cupon.valid, value: @cupon.value } }
    end
  ...
  test "should update cupon" do
    patch cupon_url(@cupon), params: { cupon: { code: @cupon.code, comment: @cupon.comment, end: @cupon.end, start: @cupon.start, valid: @cupon.valid, value: @cupon.value } }
